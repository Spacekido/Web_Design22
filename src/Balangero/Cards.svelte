...
<div class="flex-column-4">
  <div class="mdc-typography--headline3 uppercase">La miniera raccontata direttamente dai suoi testimoni</div>
  <div class="flex-row-8">
    ...
    <div class="mdc-typography--body1 hidden right flex-column-4" id="content-balangero1">
      <div>
        ...
        <span class="italic">
          ...
          maniche di cotone. Alla fine è morto di amianto: <span class="highlight">tumore al polmone</span> a 72 anni senza mai aver fumato una sigaretta. Stesso
  ...
  <div class="flex-row-8">
    <div class="mdc-typography--body1 hidden left flex-column-4" id="content-balangero2">
      <div>
